...
# Token de acceso (Se configurará de forma segura en Koyeb)
TOKEN = os.environ.get("TELEGRAM_TOKEN")

# Tu ID de Administrador oficial verificado
ADMIN_ID = 8315143020  

# Base de datos en caché para accesos activos
...
async def comprar(update: Update, context: ContextTypes.DEFAULT_TYPE):
    texto_pago = (
        ...
        "1. Realiza el abono correspondiente mediante **Yape** al número asociado.\n"
...
async def procesar_botones(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if accion == "aprobar":
        ...
        try:
            ...
            await query.edit_message_caption(caption=f"✅ Licencia activada para el ID: {cliente_id}")
        except Exception:
            await query.edit_message_caption(caption=f"✅ Aprobado, pero el chat está cerrado.")
...
def main():
    if not TOKEN:
        print("Error: TOKEN no configurada.")
        return
    ...
    print("Bot activo de forma nativa...")
    app.run_polling()
